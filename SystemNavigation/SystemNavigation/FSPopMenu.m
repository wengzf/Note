...
const CGFloat contentWidth = 138;
                         ...
                         block:(void(^)(NSInteger index)) block
{
    ...
    if (self) {
        ...
        contentView = [[UIView alloc] initWithFrame:CGRectMake(110, 110, contentWidth, contentHeight)];
        contentView.backgroundColor = [UIColor blackColor];
        contentView.layer.anchorPoint = CGPointMake((contentWidth-16-6)/contentWidth, 0);
...
//        CGPathAddLineToPoint(path, nil, capHeight-4, capHeight);
        ...
        for (int i=0; i<[titles count]; ++i) {
            ...
            // 标题
            UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(55, posy+12, 80, 20)];
