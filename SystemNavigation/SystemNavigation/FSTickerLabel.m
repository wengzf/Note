...
- (void)setSelectedCharacter:(NSString *)selectedCharacter animated:(BOOL)animated{
    ...
    if(self.scrollDirection == FSTickerLabelScrollDirectionUp){
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.scrollDirection = FSTickerLabelScrollDirectionUp;
...
- (void)insertNewTickerCharacterView{
    ...
    tickerCharacterViewFrame.origin.y = (self.scrollDirection == FSTickerLabelScrollDirectionDown) ? -self.font.lineHeight * ([self.charactersArray count] - 1) : 0;
...
- (void)updateTickerCharacterViewsFrames{
    ...
    [self.characterViewsArray enumerateObjectsUsingBlock:^(ADTickerCharacterView *numericView, NSUInteger idx, BOOL *stop) {
        ...
        numericViewFrame.origin.y = (self.scrollDirection == FSTickerLabelScrollDirectionDown) ? -self.font.lineHeight * ([self.charactersArray count] - 1) : 0;
...
- (void)setScrollDirection:(FSTickerLabelScrollDirection)scrollDirection{
    
    if(scrollDirection != _scrollDirection){
        
        _scrollDirection = scrollDirection;
        
        if(scrollDirection == FSTickerLabelScrollDirectionDown){
